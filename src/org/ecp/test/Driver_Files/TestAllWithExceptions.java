...
public class TestAllWithExceptions {

    public static void main(String[] args) {
        // TestCustomer with exceptions
        try {
            ...
            System.out.println("Exception occurred in TestCustomer: " + e.getMessage());
        }

        // TestSeller with exceptions
        try {
            ...
            System.out.println("Exception occurred in TestSeller: " + e.getMessage());
        }

        // TestUser with exceptions
        try {
            ...
            System.out.println("Exception occurred in TestUser: " + e.getMessage());
        }
    }
}
